#from LR_tuning1 gridsearch: {'model__C': 1.0, 'model__class_weight': None, 'model__penalty': 'l1', 'model__solver': 'saga', 'model__tol': 0.0001}
import pandas as pd
import numpy as np
import time
...
models = {
	'Logistic Regression': LogisticRegression(random_state=42, C=1.0, class_weight=None, penalty='l1', solver='saga', tol=0.0001, max_iter=10000),
}
results = {}
