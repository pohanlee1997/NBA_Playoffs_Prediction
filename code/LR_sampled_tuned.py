#from sampling is SMOTE(random_state=42)
import pandas as pd
import numpy as np
import time
...
models = {
	'Logistic Regression': LogisticRegression(random_state=42, C=0.1, class_weight=None, penalty='l1', solver='saga', tol=0.0001, max_iter=5000),
}
